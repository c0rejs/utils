...
const ESC = "\x1B",
    ...
    OSC = ESC + "]",
    ST = ESC + "\\",
    ANSI_REGEXP = new RegExp( /(?:\x1B\[|\u009B)[\x30-\x3F]*[\x20-\x2F]*[\x40-\x7E]/, "gv" ),

    // ANSI SGR code ends with the "m"
    ANSI_KEEP_STYLES_REGEXP = new RegExp( /(?:\x1B\[|\u009B)[\x30-\x3F]*[\x20-\x2F]*[\x40-\x6Cn~]/, "gv" ),
    ANSI_LINK_REGEXP = new RegExp( /\x1B\]8;;(.*?)\x1B\\(.*?)\x1B\]8;;\x1B\\/, "gv" ),
    RESET = CSI + "0m",
